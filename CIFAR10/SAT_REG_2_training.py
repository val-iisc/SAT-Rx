...
import argparse
##############################################################################
parser = argparse.ArgumentParser(description='Training using SAT-R2')
parser.add_argument('--exp_name',default='sat_r2_cifar10', type=str, help='Name of the experiment')
...
parser.add_argument('--lambda',default=25.0, type=float, help='lambda')
