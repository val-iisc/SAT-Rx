...
import argparse
##############################################################################
parser = argparse.ArgumentParser(description='Training LeNet+ using SAT-R1')
parser.add_argument('--exp_name',default='sat_r3_mnist', type=str, help='Name of the experiment')
...
parser.add_argument('--model_weight_prefix',default='models/mnist_lenet_plus_reg3_epoch_',type=str, help='Path to save models')
parser.add_argument('--train_log_fname',default='log/train_loss_sat_reg3.txt',type=str, help='Train loss log file name')
parser.add_argument('--results_dir',default='results/',type=str, help='Results directory')
parser.add_argument('--base_lr', default =5e-2, type=float, help='Initial learning rate')
parser.add_argument('--lambda',default=1.0, type=float, help='lambda')
parser.add_argument('--tau',default=0.4, type=float, help='tau')
parser.add_argument('--epsilon_low',  default =0.1, type=float, help='Epsilon low')
parser.add_argument('--epsilon_high', default =0.3, type=float, help='Epsilon high')
