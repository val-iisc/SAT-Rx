...
parser.add_argument('--exp_name',default='sat_r1_mnist', type=str, help='Name of the experiment')
...
parser.add_argument('--model_weight_prefix',default='models/mnist_lenet_plus_reg1_epoch_',type=str, help='Path to save models')
